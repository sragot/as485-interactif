...
- [~] Phase 5 — Base SQLite `40_base/sqdi_sante.db` : 5 tables AS + tables `effectifs`, `depenses_region`, `depenses_activites` et `depenses_sad` + dictionnaire + vues agrégées AS485-484-481-480, `v_effectifs_*`, `v_depenses_region_*`, `v_depenses_activites_*` et `v_depenses_sad_*`
- [ ] Phase 6 — Publication open data (GitHub public)
- [~] Phase 7 — Visualisation : dashboard HTML autonome (`50_publication/`), 9 onglets : AS485 desservis / AS485 attente / AS484 déficience physique / AS481 dépendance / AS480 centres jeunesse / **effectifs DI-TSA dans le temps** / **dépenses par région** / **dépenses par centre d'activités** / **SAD (soutien à domicile)**
